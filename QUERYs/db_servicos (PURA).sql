...
-- --------------------------------------------------
-- Date Created: 03/25/2016 00:25:26
-- Generated from EDMX file: C:\Users\DehBru\Documents\Visual Studio 2015\Projects\todosSevicos\todosSevicos\EF_todosServicos.edmx
-- --------------------------------------------------
...
IF OBJECT_ID(N'[dbo].[FK_TB_Soilcitacao_TB_Soilcitacao]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[TB_Soilcitacao] DROP CONSTRAINT [FK_TB_Soilcitacao_TB_Soilcitacao];
GO
IF OBJECT_ID(N'[dbo].[FK_TB_Soilcitacao_TB_SolicitacaoStatus]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[TB_Soilcitacao] DROP CONSTRAINT [FK_TB_Soilcitacao_TB_SolicitacaoStatus];
GO
...
GO
IF OBJECT_ID(N'[dbo].[TB_Soilcitacao]', 'U') IS NOT NULL
    DROP TABLE [dbo].[TB_Soilcitacao];
GO
...
-- Creating table 'TB_Soilcitacao'
CREATE TABLE [dbo].[TB_Soilcitacao] (
...
CREATE TABLE [dbo].[TB_Usuario] (
    ...
    [dtInativacao] datetime  NOT NULL
);
GO
...
-- Creating primary key on [idSolicitacao] in table 'TB_Soilcitacao'
ALTER TABLE [dbo].[TB_Soilcitacao]
ADD CONSTRAINT [PK_TB_Soilcitacao]
...
-- Creating foreign key on [idSolicitacao] in table 'TB_Soilcitacao'
ALTER TABLE [dbo].[TB_Soilcitacao]
ADD CONSTRAINT [FK_TB_Soilcitacao_TB_Soilcitacao]
    FOREIGN KEY ([idSolicitacao])
    REFERENCES [dbo].[TB_Soilcitacao]
        ([idSolicitacao])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
GO

-- Creating foreign key on [idStatus] in table 'TB_Soilcitacao'
ALTER TABLE [dbo].[TB_Soilcitacao]
ADD CONSTRAINT [FK_TB_Soilcitacao_TB_SolicitacaoStatus]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_TB_Soilcitacao_TB_SolicitacaoStatus'
CREATE INDEX [IX_FK_TB_Soilcitacao_TB_SolicitacaoStatus]
ON [dbo].[TB_Soilcitacao]
    ([idStatus]);
GO

-- Creating foreign key on [IdSolicitacao] in table 'TB_SolicitacaoServico'
ALTER TABLE [dbo].[TB_SolicitacaoServico]
ADD CONSTRAINT [FK_TB_SolicitacaoServico_TB_Soilcitacao]
    FOREIGN KEY ([IdSolicitacao])
    REFERENCES [dbo].[TB_Soilcitacao]
        ([idSolicitacao])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- Creating non-clustered index for FOREIGN KEY 'FK_TB_SolicitacaoServico_TB_Soilcitacao'
CREATE INDEX [IX_FK_TB_SolicitacaoServico_TB_Soilcitacao]
ON [dbo].[TB_SolicitacaoServico]
    ([IdSolicitacao]);
GO
