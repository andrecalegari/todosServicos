...
namespace todosServicos.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public void CreateAuthorizeTicket(int idUsuario, string userId, string roles)
        {
            FormsAuthenticationTicket authTicket = new FormsAuthenticationTicket(1, userId, /*Id do usuário é muito importante*/DateTime.Now, DateTime.Now.AddMinutes(30),  /*validade 30 min tá bom demais*/false, /*Se você deixar true, o cookie ficará no PC do usuário*/roles);
